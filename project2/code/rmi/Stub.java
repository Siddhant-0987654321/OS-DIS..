...
public abstract class Stub
{
    ...
    private static class StubHandler implements InvocationHandler, Serializable {
        ...
        private boolean localEquals(Object proxy, Object[] args){
            ...
            StubHandler iH1 = (StubHandler)Proxy.getInvocationHandler(args[0]);
            StubHandler iH2 = (StubHandler)Proxy.getInvocationHandler(proxy);
            return iH1.address.equals(iH2.address);
        }
        ...
        private int localHashCode(Object proxy, Object[] args) throws Throwable{
            ...
            StubHandler iH = (StubHandler)Proxy.getInvocationHandler(proxy);
            return iH.address.hashCode()+proxy.getClass().hashCode();
        }
        ...
        private String localToString(Object proxy, Object[] args) throws Throwable{
            ...
            String addr = "Remote address: "+iH.address.toString();
            return name+'\n'+addr+'\n';
        }
        ...
        private Object remoteInvocation(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            try{
                StubHandler iH = (StubHandler)Proxy.getInvocationHandler(proxy);
                Socket clientSocket = new Socket(iH.address.getAddress(),iH.address.getPort());
                ...
                rStatus = (RMIStatus)iStream.readObject();
                rObject = iStream.readObject();
                clientSocket.close();
                if (rStatus == RMIStatus.OK) {
                    return rObject;
                } else if (rStatus == RMIStatus.RMIExpt) {
                    throw (Throwable) rObject;
                }
            }
            catch (Exception e){
